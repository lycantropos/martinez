...
def test_symmetry(keys_pair: Tuple[SweepLineKey, SweepLineKey]) -> None:
...
def test_transitivity(keys_triplet: Tuple[SweepLineKey, SweepLineKey,
                                          SweepLineKey]) -> None:
...
@given(strategies.sweep_line_keys_pairs)
def test_connection_with_inequality(keys_pair: Tuple[SweepLineKey,
                                                     SweepLineKey]) -> None:
    first_key, second_key = keys_pair
