...
def test_basic(is_left: bool, points_pair: Tuple[BoundPoint, PortedPoint],
               ...
               in_out: bool, other_in_out: bool,
               in_result: bool, position: int, contour_id: int,
    ...
    ported = Ported(is_left, ported_point, ported_other_event,
                    ...
                    other_in_out, in_result, position, contour_id,
