...
@given(strategies.bound_with_ported_polygons_pairs,
       ...
       strategies.bound_with_ported_empty_polygons_pairs,
...
def test_basic(
        ...
        bound_with_ported_right_polygons_pair: Tuple[BoundPolygon,
                                                     PortedPolygon],
        bound_with_ported_resultant_polygons_pair: Tuple[BoundPolygon,
                                                         PortedPolygon],
    ...
    (bound_resultant,
     ported_resultant) = bound_with_ported_resultant_polygons_pair
    (bound_operation_type,
     ported_operation_type) = bound_with_ported_operations_types_pair

    bound = Bound(bound_left, bound_right, bound_resultant,
                  bound_operation_type)
    ported = Ported(ported_left, ported_right, ported_resultant,
                    ported_operation_type)
